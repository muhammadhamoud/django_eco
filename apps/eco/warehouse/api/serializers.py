...
from warehouse.models import END_DATE
...
class ProductLabelSerializer(TranslatableModelSerializer):
    translations = TranslatedFieldsField(shared_model=ProductLabel)
    class Meta:
        model = ProductLabel
        exclude = ("modified",)
