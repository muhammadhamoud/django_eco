...
from core.models import TimeStampedModel, Extensions, ModelExtensions, IncrementingIntegerField, BaseContent, DRY_TRANSLATION
...
def product_image_path(instance, filename):
    return "product/images/{}/{}".format(instance.name, filename)
...
class Category(MPTTModel):
    ...
    icon = models.ImageField(upload_to=category_image_path, blank=True, null=True)
...
class ProductImage(models.Model):
    ...
    def __str__(self):
        return f"Image of {self.translations.name}"
